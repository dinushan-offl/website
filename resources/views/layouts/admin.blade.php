...
<head>
    ...
    <link href="{{asset('css/libs/custom-dashboard.css')}}" rel="stylesheet">
        <!-- Favicon -->
    <link rel="shortcut icon" href="/public/images/media/1697366823Defyo Logo-modified.png" type="image/x-icon">
    <link rel="icon" href="/public/images/media/1697366823Defyo Logo-modified.png" type="image/x-icon">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#0">
                <div class="sidebar-brand-icon rotate-n-15">
                    <image src="/public/images/media/1697389992Black Elegant Feather Logo-modified.png" width="50"></i>
                </div>
                <div class="sidebar-brand-text mx-3">Defyo<sup>v2.0</sup></div>
            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright © Defyo™️ 2023.</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
